...
public class IceBoots extends ItemBase {
    public static final String ITEM_NAME = "ice_armor_boots";

    public IceBoots(EventBus bus, UsersService userService, ItemsService itemsService) {
    ...
    public ItemStack createItemStack(Integer count) {
        ItemStack item = new ItemStack(Material.LEATHER_BOOTS, count == null ? 1 : count);
        ...
        AttributeModifier speedModifier = new AttributeModifier(
            new NamespacedKey("nebula", ITEM_NAME+"speed_mod_boots"),
            0.03,
            Operation.ADD_NUMBER
        );
        AttributeModifier armorModifier = new AttributeModifier(
            new NamespacedKey("nebula", ITEM_NAME+"armor_mod_boots"),
            1,
            Operation.ADD_NUMBER
        );
