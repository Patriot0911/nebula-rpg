...
public class IceChestplate extends ItemBase {
    public static final String ITEM_NAME = "ice_armor_chestplate";

    public IceChestplate(EventBus bus, UsersService userService, ItemsService itemsService) {
    ...
    public String getItemKeyName() {
        return IceChestplate.ITEM_NAME;
    }
    ...
    public ItemStack createItemStack(Integer count) {
        ItemStack item = new ItemStack(Material.LEATHER_CHESTPLATE, count == null ? 1 : count);
        ...
        AttributeModifier speedModifier = new AttributeModifier(
            new NamespacedKey("nebula", ITEM_NAME+"speed_mod_chestplate"),
            0.05,
            Operation.ADD_NUMBER
        );
        AttributeModifier armorModifier = new AttributeModifier(
            new NamespacedKey("nebula", ITEM_NAME+"armor_mod_chestplate"),
            3,
            Operation.ADD_NUMBER
        );
